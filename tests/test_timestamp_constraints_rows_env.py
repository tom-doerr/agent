...
@pytest.mark.asyncio
async def test_constraints_rows_env_controls_height_and_tail(monkeypatch, tmp_path: Path):
    # Prepare 50 lines
    ...
    async with app.run_test() as pilot:
        ...
        # Height was applied (Textual stores a scalar; compare as string)
        assert str(container.styles.height) == "12"

        # Spy content and reload
