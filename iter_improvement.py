...
aspect_generator = dspy.Predict('user_request -> aspects: list[str]', instructions="Generate a list of aspects to critique the artifact based on the user request. The aspects should be specific and actionable. Please generate as many aspects as possible")
